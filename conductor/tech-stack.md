...
- **Shared Package (@repo/shared):** Centralized repository for shared TypeScript types, utility functions, and Zod validation schemas across the monorepo applications (admin, web).
