    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-6">
      ...
      <div className="relative -mt-32">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/">
                <Button size="lg" className="rounded-none px-8 py-6 text-base tracking-wide bg-gray-900 border-gray-900 hover:bg-gray-800 transition-all duration-300">
                    Return to Shop
                </Button>
            </Link>
            <Link href="/collections">
                <Button variant="outline" size="lg" className="rounded-none px-8 py-6 text-base tracking-wide border-gray-300 hover:border-gray-900 transition-all duration-300 group">
                    View Collections
