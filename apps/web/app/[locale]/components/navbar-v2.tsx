...
export const NavbarV2 = ({ items }: NavbarProps) => {
  ...
  const [expandedMobileCatalog, setExpandedMobileCatalog] = React.useState<
    string | null
  >(null);
    ...
    <>
      <nav
        ...
        onMouseLeave={(e) => {
          ...
          if (
            !relatedTarget ||
            !(e.currentTarget as Node).contains(relatedTarget)
          ) {
            setIsProductsOpen(false);
            setActiveCatalog(null);
          }
      ...
      >
        ...
        >
          ...
          {/* Tier 2: Navigation Links (Desktop) - full width, outside container */}
          <div className="hidden lg:flex items-center justify-between w-full px-6 sm:px-12 lg:px-20 xl:px-32 2xl:px-40 pb-6 pt-2">
            {[
          ...
          <div className="flex-1 overflow-y-auto px-8 py-12">
            <div className="flex flex-col gap-8">
              ...
              {[
                ...
                const key = slug.replace(/-([a-z])/g, (g, p1) =>
                  p1 ? p1.toUpperCase() : "",
                );
                return (
                  <Link
