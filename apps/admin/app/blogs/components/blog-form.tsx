...
export function BlogForm({ initialData }: BlogFormProps) {
  ...
  function onSubmit(data: BlogInput) {
    startTransition(async () => {
      const result = await upsertPost({ ...data, id: initialData?.id });
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Used in the URL: /blogs/{'{slug}'}</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                    ...
                    <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4'>
                      ...
                      <div className='space-y-1 leading-none'>
                        ...
                        <FormDescription className='text-xs'>
                          When active, this post will be visible to readers.
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Upload and manage images for this blog post.</CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
              control={form.control}
